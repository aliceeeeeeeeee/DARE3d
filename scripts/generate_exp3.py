...
def main(data_dir):
    ...
    # Movie 1_a 2_a vs Movie 3_b
    create_exp(trains=[movie_1_path, movie_2_path], vals=[movie_3_b_path], output=os.path.join(exp_dir, "a"))
    # Movie 2_a 3_a vs Movie 1_b
    create_exp(trains=[movie_2_path, movie_3_path], vals=[movie_1_b_path], output=os.path.join(exp_dir, "b"))    
    # Movie 1_a 3_a vs Movie 2_b
    create_exp(trains=[movie_1_path, movie_3_path], vals=[movie_2_b_path], output=os.path.join(exp_dir, "c"))
